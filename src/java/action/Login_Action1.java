...
public class Login_Action1 extends HttpServlet {
    ...
    private static String[] emailList = new String[10];
       ...
       private static final String SMTP_AUTH_USER = "fdsfsd03@gmail.com";                       
       private static final String SMTP_AUTH_PWD  = "03fdsfsd";
...
return new PasswordAuthentication(username, password);
  ...
  {                                                                                                                                         
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
               ...
               String msg = request.getParameter("message");
                ...
                emailMsgTxt = msg;
                emailSubjectTxt = sub;
                emailFromAddress = Login_Action1.SMTP_AUTH_USER;
    // Add List of Email address to who email needs to be sent to
            ...
            Login_Action1 smtpMailSender = new Login_Action1();
            try {
            ...
            System.out.println("Sucessfully Sent mail to All Users");
             response.sendRedirect("mail1.jsp?msg=mail sent successfully...!");
