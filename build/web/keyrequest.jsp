    ...
    <body>
        <div id="wrapper">
            <div id="header">
                ...
                <div id="menu">
                    <ul>
                        <p class="first current_page_item"><a href="consumerHome.jsp">Consumer Home</a></p>     
                ...
                <div id="splash">
                    ...
                    <table  style=" margin-left: 110px;width:70%;position:absolute;">
                        ...
                        <tr align="center" style="font-family:verdana;font-size:14px;"> 
                            ...
                            <td> <font color="#FF0000"><a href="keyrequestaction.jsp?<%=username%>,<%=filename%>">Send Key Request</a></font> </td>
                        </tr>
                        <tr>&nbsp;</tr>
                        <%
                                }
